...
\subsection{The World Wide Web Consortium (W3C)}


Tim Berners-Lee and the Inventor of the Web created W3C in October 1994. 

The W3C mission is to lead the World Wide Web to its full potential by developing protocols and guidelines that ensure the long-term growth of the Web.  W3C developed Web specifications, called ÒRecommendationsÓ, that describe communication protocols.
